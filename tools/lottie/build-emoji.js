...
const ICON = 380; // максимум, при котором даже самые тесные иконки (arrow-up, pin — меньше всего запаса из-за входа падением) не пересекают край канваса ни на одном кадре
const SW = 14; // чуть тоньше двойной реакционной — иначе тёмный контур "съедает" воспринимаемый размер иконки
